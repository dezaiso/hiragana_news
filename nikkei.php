...
$_rawData = getURL( "http://trans.hiragana.jp/ruby/http://www.nikkei.com/" );
...
/* 次は若干ややこしい。　必要な項目の開始部分と終了部分は、事前に
   ...
   する。 */
$_rawData = getBlock( " <div class=\"nx-top_news_first cmn-clearfix \">",
                      "<div class=\"nxc-control\">", $_rawData );
